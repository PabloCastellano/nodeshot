...
class TestOldImporter(TestCase):
    ...
    def setUp(self):
        for fixture in self.fixtures:
            management.call_command('loaddata', fixture, database='cnml')
    ...
    def test_command(self):
        ...
        management.call_command('import_cnml', noinput=True)
        ...
        management.call_command('import_cnml', noinput=True, verbosity=2)
